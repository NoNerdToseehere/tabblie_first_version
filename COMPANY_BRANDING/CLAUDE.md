...
| Token | Hex | Use |
|---|---|---|
| Green | `#38A169` | Checkmarks, guarantee badge, comparison table |
| Blue | `#3B7DD8` | Verified badges, shipping icon |
| Pink | `#E85B7A` | Vegan/heart icon |
| Gold | `#F5C842` | Star/effectiveness icon |
| Trustpilot Green | `#00B67A` | Review stars on product page |

**Color rules:**
- Orange is always the brand anchor
- Each product has its own identity color
